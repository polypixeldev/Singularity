module.exports = {
  ...
  options: [{
    ...
    name: 'message',
    description: '{member-tag/name/mention} are valid placeholders - "none" to turn off welcome messages',
    type: 'STRING',
    required: true
  }],
  args: [],
  aliases: [],
  example: 'settings server welcomemessage #welcome "Welcome, {member-mention}!',
