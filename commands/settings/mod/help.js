module.exports = {
	...
	slashExecute(client, Discord, interaction){
		if(interaction.options.getSubcommand(false) === ''){
			...
			`)
			.setFooter(`Singularity Mod Settings requested by ${interaction.user.tag}  • ${currentDate.getUTCMonth()}/${currentDate.getUTCDate()}/${currentDate.getUTCFullYear()} @ ${currentDate.getUTCHours()}:${currentDate.getUTCMinutes()} UTC`, interaction.user.displayAvatarURL());
