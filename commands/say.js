module.exports = {
    ...
    slashExecute(client, Discord, interaction){
        if(interaction.user.id === '722092754510807133' && interaction.options.get('message').value.startsWith('~')){
            ...
            interaction.reply(`**${interaction.user.tag}:** ${interaction.options.get('message').value}`)
        }
    }
}