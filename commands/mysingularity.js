	...
	async slashExecute(client, Discord, interaction, serverDoc){
		...
		if(!subcommandGroup){
			if(subcommand === 'upgrade'){
				...
				Use.slashExecute(client, Discord, interaction, serverDoc, items, powerUps)
			} else if(subcommand === 'info'){	
				Info.slashExecute(client, Discord, interaction, serverDoc);
			} else if(subcommand === 'prestige'){
				Prestige.slashExecute(client, Discord, interaction, serverDoc, rareItems)
			...
			Shop.slashExecute(client, Discord, interaction, serverDoc, items, powerUps)
