...
module.exports = {
	...
	async execute(client, Discord, msg, args, serverDoc){ //eslint-disable-line
	...
	async slashExecute(client, Discord, interaction, serverDoc){
		...
		// 	Times Prestiged: **${userMS.singularity.prestige}**
		// `)
		.setFooter(`${user.tag}'s Singularity requested by ${interaction.user.tag} • ${currentDate.getUTCMonth()}/${currentDate.getUTCDate()}/${currentDate.getUTCFullYear()} @ ${currentDate.getUTCHours()}:${currentDate.getUTCMinutes()} UTC`, interaction.user.displayAvatarURL());
